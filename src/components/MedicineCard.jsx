...
const MedicineCard = ({
  ...
  const stockStatus = stockQuantity !== undefined ? stockQuantity : (stock !== undefined ? stock : availability);
  const isInStock =
  ...
  const displayImage = imageUrl ? `http://localhost:8080/${imageUrl}` : image;
